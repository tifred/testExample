...
# Setting the desired_capabilities as indicated in https://saucelabs.com/platforms
        ...
        self.desired_capabilities['deviceName'] = 'Samsung Galaxy S4 Emulator'
        self.desired_capabilities['device-orientation'] = 'portrait'
        self.desired_capabilities['name'] = 'Mobile Android 4.3 Test with device Samsung Galaxy S4 Emulator'
