...
# Setting the desired_capabilities as indicated in https://saucelabs.com/platforms
        self.desired_capabilities = webdriver.DesiredCapabilities.ANDROID
        self.desired_capabilities['platform'] = 'Linux'
        self.desired_capabilities['version'] = '4.3'
        self.desired_capabilities['deviceName'] = 'Samsung Galaxy Nexus Emulator'
        self.desired_capabilities['device-orientation'] = 'portrait'
        self.desired_capabilities['name'] = 'Mobile Android 4.3 Test with device Samsung Galaxy Nexus Emulator'
